...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.answer()
    data = query.data
    print(f"🔥 button_handler: data = {data}")  # отладка
    # Старые обработчики
    if data == 'add_ing':
    ...
    # Новые обработчики для помощи
    elif data == 'help_main':
        await query.edit_message_text(HELP_MAIN, reply_markup=back_to_help_menu())
    elif data == 'help_ingredients':
        await query.edit_message_text(HELP_INGREDIENTS, reply_markup=back_to_help_menu())
    elif data == 'help_recipes':
        await query.edit_message_text(HELP_RECIPES, reply_markup=back_to_help_menu())
    elif data == 'help_sales':
        await query.edit_message_text(HELP_SALES, reply_markup=back_to_help_menu())
    elif data == 'help_writeoffs':
        await query.edit_message_text(HELP_WRITEOFFS, reply_markup=back_to_help_menu())
    elif data == 'help_customers':
        await query.edit_message_text(HELP_CUSTOMERS, reply_markup=back_to_help_menu())
    elif data == 'help_plans':
        await query.edit_message_text(HELP_PLANS, reply_markup=back_to_help_menu())
    elif data == 'help_import_export':
        await query.edit_message_text(HELP_IMPORT_EXPORT, reply_markup=back_to_help_menu())
    elif data == 'help_advanced':
        await query.edit_message_text(HELP_ADVANCED, reply_markup=back_to_help_menu())
    elif data == 'help_back':
